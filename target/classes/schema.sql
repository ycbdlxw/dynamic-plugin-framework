...
CREATE TABLE table_attribute (
  ...
  db_table   VARCHAR(100) NOT NULL PRIMARY KEY COMMENT '数据库表名',
...
-- 为测试表添加列属性配置
INSERT INTO column_attribute (db_table_name, column_name, page_name, is_show_in_list, search_flag, edit_flag, is_required, default_value, order_no) VALUES
('test_preprocessor', 'id', 'ID', TRUE, FALSE, FALSE, FALSE, NULL, 1),
('test_preprocessor', 'title', '标题', TRUE, TRUE, TRUE, TRUE, NULL, 2),
('test_preprocessor', 'user_id', '用户ID', TRUE, TRUE, TRUE, FALSE, 'userId()', 3),
('test_preprocessor', 'org_id', '组织ID', TRUE, TRUE, TRUE, FALSE, 'orgId()', 4),
('test_preprocessor', 'status', '状态', TRUE, TRUE, TRUE, FALSE, '1', 5),
('test_preprocessor', 'content', '内容', TRUE, FALSE, TRUE, FALSE, NULL, 6),
('test_preprocessor', 'created_at', '创建时间', TRUE, FALSE, FALSE, FALSE, NULL, 7),
('test_preprocessor', 'updated_at', '更新时间', TRUE, FALSE, FALSE, FALSE, NULL, 8),
('test_preprocessor', 'create_by', '创建人', TRUE, FALSE, FALSE, FALSE, NULL, 9),
('test_preprocessor', 'update_by', '更新人', TRUE, FALSE, FALSE, FALSE, NULL, 10); 